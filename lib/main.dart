...
void main() async {
  ...
  // Register periodic task for every 1 hour to keep widget fresh
  ...
  runApp(const ProviderScope(child: ClassWidgetApp()));
}

class ClassWidgetApp extends ConsumerWidget {
  const ClassWidgetApp({super.key});
